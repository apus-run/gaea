...
func TestContext(t *testing.T) {
	type ctxKey1 struct{}
	type ctxKey2 struct{}
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/apus-run/gaea")
	ctx2 := context.WithValue(context.Background(), ctxKey2{}, "https://apus.run/")
	...
	if !reflect.DeepEqual(value1, "https://github.com/apus-run/gaea") {
		t.Errorf("expect %v, got %v", "https://github.com/apus-run/gaea", value1)
	}
	...
	if !reflect.DeepEqual("https://apus.run/", value2) {
		t.Errorf("expect %v, got %v", "https://apus.run/", value2)
	}
...
func TestMerge(t *testing.T) {
	...
	cancel()
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/apus-run/gaea")
	ctx2 := context.WithValue(ctx, ctxKey2{}, "https://apus.run/")
	...
	if !reflect.DeepEqual(value2, "https://apus.run/") {
		t.Errorf("expect %v, got %v", " https://apus.run/", value2)
	}
